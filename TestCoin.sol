...
contract MintableToken is BasicToken {
  ...
  function mint(address to, uint tokens) onlyOwner public {
    /*basically this function write how many tokens an user will 
    receive and how many tokens the totalSupply will increase*/
    _balances[to] = _balances[to].add(tokens);
...
contract KaueCoin is MintableToken {
  string public constant name = "Kaue Coin";
